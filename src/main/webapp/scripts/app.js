...
var recommendApp = angular.module('recommendApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'recommendAppUtils', 'pascalprecht.translate', 'truncate']);
